...
enum WorldConfigs
{
    ...
    //Classic Instances
    CONFIG_UINT32_SHADOWFANGKEEP_LEVEL,
    CONFIG_UINT32_STOCKADES_LEVEL,
    CONFIG_UINT32_DEADMINES_LEVEL,
    CONFIG_UINT32_WAILINGCAVERNS_LEVEL,
    CONFIG_UINT32_RAZORFENKRAULINSTANCE_LEVEL,
    CONFIG_UINT32_BLACKFATHOM_LEVEL,
    CONFIG_UINT32_ULDAMAN_LEVEL,
    CONFIG_UINT32_GNOMERAGONINSTANCE_LEVEL,
    CONFIG_UINT32_SUNKENTEMPLE_LEVEL,
    CONFIG_UINT32_RAZORFENDOWNS_LEVEL,
    CONFIG_UINT32_MONASTERYINSTANCES_LEVEL,
    CONFIG_UINT32_TANARISINSTANCE_LEVEL,
    CONFIG_UINT32_BLACKROCKSPIRE_LEVEL,
    CONFIG_UINT32_BLACKROCKDEPTHS_LEVEL,
    CONFIG_UINT32_ONYXIALAIRINSTANCE_LEVEL,
    CONFIG_UINT32_SCHOOLOFNECROMANCY_LEVEL,
    CONFIG_UINT32_ZULGURUB_LEVEL,
    CONFIG_UINT32_STRATHOLME_LEVEL,
    CONFIG_UINT32_MAURADON_LEVEL,
    CONFIG_UINT32_ORGRIMMARINSTANCE_LEVEL,
    CONFIG_UINT32_MOLTENCORE_LEVEL,
    CONFIG_UINT32_DIREMAUL_LEVEL,
    CONFIG_UINT32_BLACKWINGLAIR_LEVEL,
    CONFIG_UINT32_AHNQIRAJ_LEVEL,
    CONFIG_UINT32_AHNQIRAJTEMPLE_LEVEL,
    //TBC Instances
    CONFIG_UINT32_CAVERNSOFTIME_LEVEL,
    CONFIG_UINT32_KARAZAHN_LEVEL,
    CONFIG_UINT32_HYJALPAST_LEVEL,
    CONFIG_UINT32_HELLFIREMILITARY_LEVEL,
    CONFIG_UINT32_HELLFIREDEMON_LEVEL,
    CONFIG_UINT32_HELLFIRERAMPART_LEVEL,
    CONFIG_UINT32_HELLFIRERAID_LEVEL,
    CONFIG_UINT32_COILFANGPUMPING_LEVEL,
    CONFIG_UINT32_COILFANGMARSH_LEVEL,
    CONFIG_UINT32_COILFANGDRAENEI_LEVEL,
    CONFIG_UINT32_COILFANGRAID_LEVEL,
    CONFIG_UINT32_TEMPESTKEEPRAID_LEVEL,
    CONFIG_UINT32_TEMPESTKEEPARCANE_LEVEL,
    CONFIG_UINT32_TEMPESTKEEPATRIUM_LEVEL,
    CONFIG_UINT32_TEMPESTKEEPFACTORY_LEVEL,
    CONFIG_UINT32_AUCHINDOUNSHADOW_LEVEL,
    CONFIG_UINT32_AUCHINDOUNDEMON_LEVEL,
    CONFIG_UINT32_AUCHINDOUNETHEREAL_LEVEL,
    CONFIG_UINT32_AUCHINDOUNDRAENEI_LEVEL,
    CONFIG_UINT32_HILLSBRADPAST_LEVEL,
    CONFIG_UINT32_BLACKTEMPLE_LEVEL,
    CONFIG_UINT32_GRUULSLAIR_LEVEL,
...
enum Rates
{
    ...
    CONFIG_FLOAT_SOLOCRAFT_STATS_MULT,
    //Dungeon Catch-all
    CONFIG_FLOAT_DUNGEON_DIFF,
    CONFIG_FLOAT_HEROIC_DIFF,
    CONFIG_FLOAT_RAID25_DIFF,
    CONFIG_FLOAT_RAID40_DIFF,
    //Classic Instances
    CONFIG_FLOAT_SHADOWFANGKEEP_DIFF,
    CONFIG_FLOAT_STOCKADES_DIFF,
    CONFIG_FLOAT_DEADMINES_DIFF,
    CONFIG_FLOAT_WAILINGCAVERNS_DIFF,
    CONFIG_FLOAT_RAZORFENKRAULINSTANCE_DIFF,
    CONFIG_FLOAT_BLACKFATHOM_DIFF,
    CONFIG_FLOAT_ULDAMAN_DIFF,
    CONFIG_FLOAT_GNOMERAGONINSTANCE_DIFF,
    CONFIG_FLOAT_SUNKENTEMPLE_DIFF,
    ...
    CONFIG_FLOAT_BLACKROCKDEPTHS_DIFF,
    CONFIG_FLOAT_ONYXIALAIRINSTANCE_DIFF,
    CONFIG_FLOAT_SCHOOLOFNECROMANCY_DIFF,
    CONFIG_FLOAT_ZULGURUB_DIFF,
    CONFIG_FLOAT_STRATHOLME_DIFF,
    CONFIG_FLOAT_MAURADON_DIFF,
    CONFIG_FLOAT_ORGRIMMARINSTANCE_DIFF,
    CONFIG_FLOAT_MOLTENCORE_DIFF,
    CONFIG_FLOAT_DIREMAUL_DIFF,
    CONFIG_FLOAT_BLACKWINGLAIR_DIFF,
    CONFIG_FLOAT_AHNQIRAJ_DIFF,
    CONFIG_FLOAT_AHNQIRAJTEMPLE_DIFF,
    //TBC Instances
    CONFIG_FLOAT_CAVERNSOFTIME_DIFF,
    ...
    CONFIG_FLOAT_HELLFIRERAID_DIFF,
    CONFIG_FLOAT_COILFANGPUMPING_DIFF,
    CONFIG_FLOAT_COILFANGMARSH_DIFF,
    CONFIG_FLOAT_COILFANGDRAENEI_DIFF,
    CONFIG_FLOAT_COILFANGRAID_DIFF,
    CONFIG_FLOAT_TEMPESTKEEPRAID_DIFF,
    CONFIG_FLOAT_TEMPESTKEEPARCANE_DIFF,
    CONFIG_FLOAT_TEMPESTKEEPATRIUM_DIFF,
    CONFIG_FLOAT_TEMPESTKEEPFACTORY_DIFF,
    CONFIG_FLOAT_AUCHINDOUNSHADOW_DIFF,
    CONFIG_FLOAT_AUCHINDOUNDEMON_DIFF,
    CONFIG_FLOAT_AUCHINDOUNETHEREAL_DIFF,
    CONFIG_FLOAT_AUCHINDOUNDRAENEI_DIFF,
    CONFIG_FLOAT_HILLSBRADPAST_DIFF,
    CONFIG_FLOAT_BLACKTEMPLE_DIFF,
    CONFIG_FLOAT_GRUULSLAIR_DIFF,
    CONFIG_FLOAT_ZULAMAN_DIFF,
    CONFIG_FLOAT_SUNWELLPLATEAU_DIFF,
    CONFIG_FLOAT_SUNWELL5MANFIX_DIFF,
    //TBC Heroic Instances
    CONFIG_FLOAT_HEROIC_CAVERNSOFTIME_DIFF,
    CONFIG_FLOAT_HEROIC_HELLFIREMILITARY_DIFF,
    CONFIG_FLOAT_HEROIC_HELLFIREDEMON_DIFF,
    CONFIG_FLOAT_HEROIC_HELLFIRERAMPART_DIFF,
    CONFIG_FLOAT_HEROIC_COILFANGPUMPING_DIFF,
    CONFIG_FLOAT_HEROIC_COILFANGMARSH_DIFF,
    CONFIG_FLOAT_HEROIC_COILFANGDRAENEI_DIFF,
    CONFIG_FLOAT_HEROIC_TEMPESTKEEPARCANE_DIFF,
    CONFIG_FLOAT_HEROIC_TEMPESTKEEPATRIUM_DIFF,
    CONFIG_FLOAT_HEROIC_TEMPESTKEEPFACTORY_DIFF,
    CONFIG_FLOAT_HEROIC_AUCHINDOUNSHADOW_DIFF,
    CONFIG_FLOAT_HEROIC_AUCHINDOUNDEMON_DIFF,
    CONFIG_FLOAT_HEROIC_AUCHINDOUNETHEREAL_DIFF,
    CONFIG_FLOAT_HEROIC_AUCHINDOUNDRAENEI_DIFF,
    CONFIG_FLOAT_HEROIC_HILLSBRADPAST_DIFF,
    CONFIG_FLOAT_HEROIC_ZULAMAN_DIFF,
