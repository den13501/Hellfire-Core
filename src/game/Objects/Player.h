...
class Player : public Unit
{
    ...
    public:
        ...
        bool isGMChat() const { return GetSession()->HasHigherGMLevel(SEC_GAMEMASTER) && (m_ExtraFlags & PLAYER_EXTRA_GM_CHAT); }
        void SetGMChat(bool on) { if (on) m_ExtraFlags |= PLAYER_EXTRA_GM_CHAT; else m_ExtraFlags &= ~PLAYER_EXTRA_GM_CHAT; }
        bool isGMTriggersVisible() const {return GetSession()->HasHigherGMLevel(SEC_GAMEMASTER) && (m_ExtraFlags & PLAYER_EXTRA_GM_ON) && !(m_ExtraFlags & PLAYER_EXTRA_GM_TRIGGERS); }
