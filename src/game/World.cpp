...
void World::LoadConfigSettings(bool reload)
{
    ...
    loadConfig(CONFIG_BOOL_SOLOCRAFT_ENABLED, "Solocraft.Enable", true);
    loadConfig(CONFIG_BOOL_SOLOCRAFT_ANNOUNCE, "Solocraft.Announce", true);

    //Balancing
    loadConfig(CONFIG_BOOL_SOLOCRAFT_DEBUFF_ENABLE, "SoloCraft.Debuff.Enable", 1);
    loadConfig(CONFIG_FLOAT_SOLOCRAFT_SPELLPOWER_MULT, "SoloCraft.Spellpower.Mult", 2.5);
    loadConfig(CONFIG_FLOAT_SOLOCRAFT_STATS_MULT, "SoloCraft.Stats.Mult", 100.0);
    //Level Thresholds
    loadConfig(CONFIG_UINT32_SOLOCRAFT_MAX_LEVEL_DIFF, "Solocraft.Max.Level.Diff", 10);
    //Dungeon Values
    //Default
    loadConfig(CONFIG_UINT32_DUNGEON_LEVEL, "Solocraft.Dungeon.Level", 70);
    //Classic Instances
    loadConfig(CONFIG_UINT32_SHADOWFANGKEEP_LEVEL, "Solocraft.ShadowfangKeep.Level", 15);
    loadConfig(CONFIG_UINT32_STOCKADES_LEVEL, "Solocraft.Stockades.Level", 22);
    loadConfig(CONFIG_UINT32_DEADMINES_LEVEL, "Solocraft.Deadmines.Level", 18);
    loadConfig(CONFIG_UINT32_WAILINGCAVERNS_LEVEL, "Solocraft.WailingCaverns.Level", 17);
    loadConfig(CONFIG_UINT32_RAZORFENKRAULINSTANCE_LEVEL, "Solocraft.RazorfenKraulInstance.Level", 30);
    loadConfig(CONFIG_UINT32_BLACKFATHOM_LEVEL, "Solocraft.Blackfathom.Level", 20);
    loadConfig(CONFIG_UINT32_ULDAMAN_LEVEL, "Solocraft.Uldaman.Level", 40);
    loadConfig(CONFIG_UINT32_GNOMERAGONINSTANCE_LEVEL, "Solocraft.GnomeragonInstance.Level", 24);
    loadConfig(CONFIG_UINT32_SUNKENTEMPLE_LEVEL, "Solocraft.SunkenTemple.Level", 50);
    loadConfig(CONFIG_UINT32_RAZORFENDOWNS_LEVEL, "Solocraft.RazorfenDowns.Level", 40);
    loadConfig(CONFIG_UINT32_MONASTERYINSTANCES_LEVEL, "Solocraft.MonasteryInstances.Level", 35);
    loadConfig(CONFIG_UINT32_TANARISINSTANCE_LEVEL, "Solocraft.TanarisInstance.Level", 44);
    loadConfig(CONFIG_UINT32_BLACKROCKSPIRE_LEVEL, "Solocraft.BlackRockSpire.Level", 55);
    loadConfig(CONFIG_UINT32_BLACKROCKDEPTHS_LEVEL, "Solocraft.BlackrockDepths.Level", 50);
    loadConfig(CONFIG_UINT32_ONYXIALAIRINSTANCE_LEVEL, "Solocraft.OnyxiaLairInstance.Level", 60);
    loadConfig(CONFIG_UINT32_SCHOOLOFNECROMANCY_LEVEL, "Solocraft.SchoolofNecromancy.Level", 55);
    loadConfig(CONFIG_UINT32_ZULGURUB_LEVEL, "Solocraft.Zul'gurub.Level", 60);
    loadConfig(CONFIG_UINT32_STRATHOLME_LEVEL, "Solocraft.Stratholme.Level", 55);
    loadConfig(CONFIG_UINT32_MAURADON_LEVEL, "Solocraft.Mauradon.Level", 48);
    loadConfig(CONFIG_UINT32_ORGRIMMARINSTANCE_LEVEL, "Solocraft.OrgrimmarInstance.Level", 15);
    loadConfig(CONFIG_UINT32_MOLTENCORE_LEVEL, "Solocraft.MoltenCore.Level", 60);
    loadConfig(CONFIG_UINT32_DIREMAUL_LEVEL, "Solocraft.DireMaul.Level", 48);
    loadConfig(CONFIG_UINT32_BLACKWINGLAIR_LEVEL, "Solocraft.BlackwingLair.Level", 40);
    loadConfig(CONFIG_UINT32_AHNQIRAJ_LEVEL, "Solocraft.AhnQiraj.Level", 60);
    loadConfig(CONFIG_UINT32_AHNQIRAJTEMPLE_LEVEL, "Solocraft.AhnQirajTemple.Level", 60);
    //TBC Instances
    loadConfig(CONFIG_UINT32_CAVERNSOFTIME_LEVEL, "Solocraft.CavernsOfTime.Level", 68);
    loadConfig(CONFIG_UINT32_KARAZAHN_LEVEL, "Solocraft.Karazahn.Level", 68);
    loadConfig(CONFIG_UINT32_HYJALPAST_LEVEL, "Solocraft.HyjalPast.Level", 70);
    loadConfig(CONFIG_UINT32_HELLFIREMILITARY_LEVEL, "Solocraft.HellfireMilitary.Level", 68);
    loadConfig(CONFIG_UINT32_HELLFIREDEMON_LEVEL, "Solocraft.HellfireDemon.Level", 68);
    loadConfig(CONFIG_UINT32_HELLFIRERAMPART_LEVEL, "Solocraft.HellfireRampart.Level", 68);
    loadConfig(CONFIG_UINT32_HELLFIRERAID_LEVEL, "Solocraft.HellfireRaid.Level", 68);
    loadConfig(CONFIG_UINT32_COILFANGPUMPING_LEVEL, "Solocraft.CoilfangPumping.Level", 68);
    loadConfig(CONFIG_UINT32_COILFANGMARSH_LEVEL, "Solocraft.CoilfangMarsh.Level", 68);
    loadConfig(CONFIG_UINT32_COILFANGDRAENEI_LEVEL, "Solocraft.CoilfangDraenei.Level", 68);
    loadConfig(CONFIG_UINT32_COILFANGRAID_LEVEL, "Solocraft.CoilfangRaid.Level", 70);
    loadConfig(CONFIG_UINT32_TEMPESTKEEPRAID_LEVEL, "Solocraft.TempestKeepRaid.Level", 70);
    loadConfig(CONFIG_UINT32_TEMPESTKEEPARCANE_LEVEL, "Solocraft.TempestKeepArcane.Level", 68);
    loadConfig(CONFIG_UINT32_TEMPESTKEEPATRIUM_LEVEL, "Solocraft.TempestKeepAtrium.Level", 68);
    loadConfig(CONFIG_UINT32_TEMPESTKEEPFACTORY_LEVEL, "Solocraft.TempestKeepFactory.Level", 68);
    loadConfig(CONFIG_UINT32_AUCHINDOUNSHADOW_LEVEL, "Solocraft.AuchindounShadow.Level", 68);
    loadConfig(CONFIG_UINT32_AUCHINDOUNDEMON_LEVEL, "Solocraft.AuchindounDemon.Level", 68);
    loadConfig(CONFIG_UINT32_AUCHINDOUNETHEREAL_LEVEL, "Solocraft.AuchindounEthereal.Level", 68);
    loadConfig(CONFIG_UINT32_AUCHINDOUNDRAENEI_LEVEL, "Solocraft.AuchindounDraenei.Level", 68);
    loadConfig(CONFIG_UINT32_HILLSBRADPAST_LEVEL, "Solocraft.HillsbradPast.Level", 68);
    loadConfig(CONFIG_UINT32_BLACKTEMPLE_LEVEL, "Solocraft.BlackTemple.Level", 70);
    loadConfig(CONFIG_UINT32_GRUULSLAIR_LEVEL, "Solocraft.GruulsLair.Level", 70);
    loadConfig(CONFIG_UINT32_ZULAMAN_LEVEL, "Solocraft.ZulAman.Level", 68);
    loadConfig(CONFIG_UINT32_SUNWELLPLATEAU_LEVEL, "Solocraft.SunwellPlateau.Level", 70);
    loadConfig(CONFIG_UINT32_SUNWELL5MANFIX_LEVEL, "Solocraft.Sunwell5ManFix.Level", 68);

    //Dungeon Difficulty
    //Catch alls
    loadConfig(CONFIG_FLOAT_DUNGEON_DIFF, "Solocraft.Dungeon", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_DIFF, "Solocraft.Heroic", 10.0);
    loadConfig(CONFIG_FLOAT_RAID25_DIFF, "Solocraft.Raid25", 25.0);
    loadConfig(CONFIG_FLOAT_RAID40_DIFF, "Solocraft.Raid40", 40.0);
    //Classic Instances
    loadConfig(CONFIG_FLOAT_SHADOWFANGKEEP_DIFF, "Solocraft.ShadowfangKeep", 5.0);
    loadConfig(CONFIG_FLOAT_STOCKADES_DIFF, "Solocraft.Stockades", 5.0);
    loadConfig(CONFIG_FLOAT_DEADMINES_DIFF, "Solocraft.Deadmines", 5.0);
    loadConfig(CONFIG_FLOAT_WAILINGCAVERNS_DIFF, "Solocraft.WailingCaverns", 5.0);
    loadConfig(CONFIG_FLOAT_RAZORFENKRAULINSTANCE_DIFF, "Solocraft.RazorfenKraulInstance", 5.0);
    loadConfig(CONFIG_FLOAT_BLACKFATHOM_DIFF, "Solocraft.Blackfathom", 5.0);
    loadConfig(CONFIG_FLOAT_ULDAMAN_DIFF, "Solocraft.Uldaman", 5.0);
    loadConfig(CONFIG_FLOAT_GNOMERAGONINSTANCE_DIFF, "Solocraft.GnomeragonInstance", 5.0);
    loadConfig(CONFIG_FLOAT_SUNKENTEMPLE_DIFF, "Solocraft.SunkenTemple", 5.0);
    loadConfig(CONFIG_FLOAT_RAZORFENDOWNS_DIFF, "Solocraft.RazorfenDowns", 5.0);
    loadConfig(CONFIG_FLOAT_MONASTERYINSTANCES_DIFF, "Solocraft.MonasteryInstances", 5.0);
    loadConfig(CONFIG_FLOAT_TANARISINSTANCE_DIFF, "Solocraft.TanarisInstance", 5.0);
    loadConfig(CONFIG_FLOAT_BLACKROCKSPIRE_DIFF, "Solocraft.BlackRockSpire", 10.0);
    loadConfig(CONFIG_FLOAT_BLACKROCKDEPTHS_DIFF, "Solocraft.BlackrockDepths", 5.0);
    loadConfig(CONFIG_FLOAT_ONYXIALAIRINSTANCE_DIFF, "Solocraft.OnyxiaLairInstance", 40.0);
    loadConfig(CONFIG_FLOAT_SCHOOLOFNECROMANCY_DIFF, "Solocraft.SchoolofNecromancy", 5.0);
    loadConfig(CONFIG_FLOAT_ZULGURUB_DIFF, "Solocraft.Zul'gurub", 20.0);
    loadConfig(CONFIG_FLOAT_STRATHOLME_DIFF, "Solocraft.Stratholme", 5.0);
    loadConfig(CONFIG_FLOAT_MAURADON_DIFF, "Solocraft.Mauradon", 5.0);
    loadConfig(CONFIG_FLOAT_ORGRIMMARINSTANCE_DIFF, "Solocraft.OrgrimmarInstance", 5.0);
    loadConfig(CONFIG_FLOAT_MOLTENCORE_DIFF, "Solocraft.MoltenCore", 40.0);
    loadConfig(CONFIG_FLOAT_DIREMAUL_DIFF, "Solocraft.DireMaul", 5.0);
    loadConfig(CONFIG_FLOAT_BLACKWINGLAIR_DIFF, "Solocraft.BlackwingLair", 40.0);
    loadConfig(CONFIG_FLOAT_AHNQIRAJ_DIFF, "Solocraft.AhnQiraj", 20.0);
    loadConfig(CONFIG_FLOAT_AHNQIRAJTEMPLE_DIFF, "Solocraft.AhnQirajTemple", 40.0);
    //TBC Instances
    loadConfig(CONFIG_FLOAT_CAVERNSOFTIME_DIFF, "Solocraft.CavernsOfTime", 5.0);
    loadConfig(CONFIG_FLOAT_KARAZAHN_DIFF, "Solocraft.Karazahn", 10.0);
    loadConfig(CONFIG_FLOAT_HYJALPAST_DIFF, "Solocraft.HyjalPast", 25.0);
    loadConfig(CONFIG_FLOAT_HELLFIREMILITARY_DIFF, "Solocraft.HellfireMilitary", 5.0);
    loadConfig(CONFIG_FLOAT_HELLFIREDEMON_DIFF, "Solocraft.HellfireDemon", 5.0);
    loadConfig(CONFIG_FLOAT_HELLFIRERAMPART_DIFF, "Solocraft.HellfireRampart", 5.0);
    loadConfig(CONFIG_FLOAT_HELLFIRERAID_DIFF, "Solocraft.HellfireRaid", 25.0);
    loadConfig(CONFIG_FLOAT_COILFANGPUMPING_DIFF, "Solocraft.CoilfangPumping", 5.0);
    loadConfig(CONFIG_FLOAT_COILFANGMARSH_DIFF, "Solocraft.CoilfangMarsh", 5.0);
    loadConfig(CONFIG_FLOAT_COILFANGDRAENEI_DIFF, "Solocraft.CoilfangDraenei", 5.0);
    loadConfig(CONFIG_FLOAT_COILFANGRAID_DIFF, "Solocraft.CoilfangRaid", 25.0);
    loadConfig(CONFIG_FLOAT_TEMPESTKEEPRAID_DIFF, "Solocraft.TempestKeepRaid", 25.0);
    loadConfig(CONFIG_FLOAT_TEMPESTKEEPARCANE_DIFF, "Solocraft.TempestKeepArcane", 5.0);
    loadConfig(CONFIG_FLOAT_TEMPESTKEEPATRIUM_DIFF, "Solocraft.TempestKeepAtrium", 5.0);
    loadConfig(CONFIG_FLOAT_TEMPESTKEEPFACTORY_DIFF, "Solocraft.TempestKeepFactory", 5.0);
    loadConfig(CONFIG_FLOAT_AUCHINDOUNSHADOW_DIFF, "Solocraft.AuchindounShadow", 5.0);
    loadConfig(CONFIG_FLOAT_AUCHINDOUNDEMON_DIFF, "Solocraft.AuchindounDemon", 5.0);
    loadConfig(CONFIG_FLOAT_AUCHINDOUNETHEREAL_DIFF, "Solocraft.AuchindounEthereal", 5.0);
    loadConfig(CONFIG_FLOAT_AUCHINDOUNDRAENEI_DIFF, "Solocraft.AuchindounDraenei", 5.0);
    loadConfig(CONFIG_FLOAT_HILLSBRADPAST_DIFF, "Solocraft.HillsbradPast", 5.0);
    loadConfig(CONFIG_FLOAT_BLACKTEMPLE_DIFF, "Solocraft.BlackTemple", 25.0);
    loadConfig(CONFIG_FLOAT_GRUULSLAIR_DIFF, "Solocraft.GruulsLair", 25.0);
    loadConfig(CONFIG_FLOAT_ZULAMAN_DIFF, "Solocraft.ZulAman", 5.0);
    loadConfig(CONFIG_FLOAT_SUNWELLPLATEAU_DIFF, "Solocraft.SunwellPlateau", 25.0);
    loadConfig(CONFIG_FLOAT_SUNWELL5MANFIX_DIFF, "Solocraft.Sunwell5ManFix", 5.0);
    //TBC Heroics
    loadConfig(CONFIG_FLOAT_HEROIC_CAVERNSOFTIME_DIFF, "Solocraft.CavernsOfTimeH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_HELLFIREMILITARY_DIFF, "Solocraft.HellfireMilitaryH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_HELLFIREDEMON_DIFF, "Solocraft.HellfireDemonH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_HELLFIRERAMPART_DIFF, "Solocraft.HellfireRampartH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_COILFANGPUMPING_DIFF, "Solocraft.CoilfangPumpingH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_COILFANGMARSH_DIFF, "Solocraft.CoilfangMarshH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_COILFANGDRAENEI_DIFF, "Solocraft.CoilfangDraeneiH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_TEMPESTKEEPARCANE_DIFF, "Solocraft.TempestKeepArcaneH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_TEMPESTKEEPATRIUM_DIFF, "Solocraft.TempestKeepAtriumH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_TEMPESTKEEPFACTORY_DIFF, "Solocraft.TempestKeepFactoryH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_AUCHINDOUNSHADOW_DIFF, "Solocraft.AuchindounShadowH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_AUCHINDOUNDEMON_DIFF, "Solocraft.AuchindounDemonH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_AUCHINDOUNETHEREAL_DIFF, "Solocraft.AuchindounEtherealH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_AUCHINDOUNDRAENEI_DIFF, "Solocraft.AuchindounDraeneiH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_HILLSBRADPAST_DIFF, "Solocraft.HillsbradPastH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_ZULAMAN_DIFF, "Solocraft.ZulAmanH", 5.0);
    loadConfig(CONFIG_FLOAT_HEROIC_SUNWELL5MANFIX_DIFF, "Solocraft.Sunwell5ManFixH", 5.0);
...
void World::SetInitialWorldSettings()
{
    ...
    {
        sLog.outLog(LOG_DEFAULT, "ERROR: Correct *.map files for startup zones not found in path '%smaps'. Please place *.map files in appropriate directories or correct the DataDir value in the .conf file.",m_dataPath.c_str());
        exit(1);
    }
...
void World::Update(uint32 diff)
{
    ...
    diffRecorder.RecordTimeFor("Timers", 2);

    ///- Update the game time and check for shutdown time
    _UpdateGameTime();

    diffRecorder.RecordTimeFor("Gametime", 2);
    ...
    if (m_gameTime > m_NextDailyQuestReset)
    {
        ...
        diffRecorder.RecordTimeFor("Reset daily quests", 5);
    }
    ...
    if (m_timers[WUPDATE_OLDMAILS].Passed())
    {
        ...
        diffRecorder.RecordTimeFor("Return old mails", 5);
    }
    ...
    if (m_timers[WUPDATE_SESSIONS].Passed())
    {
        ...
        diffRecorder.RecordTimeFor("Groups", 10);

        sObjectMgr.UpdateRolls(diff);
        diffRecorder.RecordTimeFor("Rolls", 10);
    }

    sWorldEventProcessor.ExecuteEvents();
    diffRecorder.RecordTimeFor("World events", 10);
    ...
    if (m_timers[WUPDATE_WEATHERS].Passed())
    {
        ...
        diffRecorder.RecordTimeFor("Weathers", 5);
    }
    ...
    diffRecorder.RecordTimeFor("Uptime", 2);
    ...
    if (m_timers[WUPDATE_GUILD_ANNOUNCES].Passed())
    {
        ...
        diffRecorder.RecordTimeFor("Send guild announce", 2);
    }
    ...
    if (m_timers[WUPDATE_DELETECHARS].Passed())
    {
        ...
        CleanupDeletedChars();
        diffRecorder.RecordTimeFor("Cleanup deleted characters", 2);
    }
    ...
    if (m_timers[WUPDATE_CORPSES].Passed())
    {
        ...
        diffRecorder.RecordTimeFor("Remove old corpses", 5);
    }
...
BanReturn World::BanAccount(BanMode mode, std::string nameIPOrMail, std::string duration, std::string reason, std::string author)
{
    ...
    switch (mode)
    {
        case BAN_IP:
            ...
            AccountsDatabase.PExecute("INSERT INTO ip_banned VALUES ('%s', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+%u, '%s', '%s', 1)", nameIPOrMail.c_str(), duration_secs, safe_author.c_str(), reason.c_str());
            break;
        case BAN_ACCOUNT:
